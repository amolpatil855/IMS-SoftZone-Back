...
{
    public class VMFWRQualityFlatUpload
    {
        [Required]
        ...
        [Required]
        [Range(1, 99999.99, ErrorMessage = "Flat Rate is out of range")]
        public Nullable<decimal> flatRate { get; set; }

        [Required]
        [Range(1, 99999.99, ErrorMessage = "Purchase Flat Rate is out of range")]
        public Nullable<decimal> purchaseFlatRate { get; set; }

        [Required]
        [Range(1, 99.99, ErrorMessage = "Max Flat Rate Discount(%) is out if range")]
