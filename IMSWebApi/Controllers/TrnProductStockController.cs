...
namespace IMSWebApi.Controllers
{
    ...
    public class TrnProductStockController : ApiController
    {
        ...
        public IHttpActionResult GetProductDetails(long categoryId, long? collectionId, long? parameterId, long? qualityId, long? matThicknessId, string matSizeCode)
        {
            var result = _trnProductStockService.getProductStockAvailablity(categoryId, collectionId, parameterId, qualityId, matThicknessId, matSizeCode);
            return Ok(result);
        }
    }
}
