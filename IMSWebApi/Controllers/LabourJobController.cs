...
namespace IMSWebApi.Controllers
{
    public class LabourJobController : ApiController
    {
        ...
        [HttpGet]
        public IHttpActionResult Get(int pageSize = 0, int page = 0, string isPaid = null, long? tailorId = null, DateTime? startDate = null, DateTime? endDate = null)
        {
            var result = _labourJobService.getLabourJobs(pageSize, page, isPaid, tailorId, startDate, endDate);
            return Ok(result);
        }
